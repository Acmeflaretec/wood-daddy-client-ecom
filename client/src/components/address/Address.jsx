...
const Address = () => {
  ...
  const fetchAddress = async () => {
    try {
      const response = await axiosInstance.get(`/address/getaddresses`);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    await axiosInstance.post(`/address/address`, formData);
    await fetchAddress();
  ...
  const handleEdit = (index) => {
    setFormData(addressesData[index]);
  ...
  const handleDefault = async (addressId) => {
    await axiosInstance.put(`/address/setdefault/${addressId}`);
    await fetchAddress();
  };
                  ...
                  <ListItem disablePadding>
                    ...
                    <ListItemSecondaryAction>
                      ...
                      <IconButton
                        edge="end"
                        aria-label="delete"
                        onClick={() => handleDelete(index, address._id)}
                        color="error"
                      >
                        <DeleteIcon />
                      </IconButton>
