...
import { useAddBanner } from "queries/ProductQuery";
...
const AddBanner = () => {
  ...
  const { mutateAsync: addCategory, isLoading } = useAddBanner()
  ...
  const handleSubmit = ()=>{
    try {
      ...
      typeof(data.image) == 'object' && formData.append("banner", data.image, data?.image?.name);
